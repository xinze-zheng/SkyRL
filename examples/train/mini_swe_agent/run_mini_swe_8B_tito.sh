...
# TITO + Renderer training for Qwen3-8B on SWE-Bench.
# Single node, 8 GPUs, colocated training+generation.
#
# Prerequisites:
#   python examples/train/mini_swe_agent/preprocess_swegym.py --output_dir ~/data/swe_gym_subset
#
# Usage:
#   bash examples/train/mini_swe_agent/run_mini_swe_8B_tito.sh
#   # Override any param:
#   bash examples/train/mini_swe_agent/run_mini_swe_8B_tito.sh trainer.epochs=3

DATA_DIR="$HOME/data/swe_gym_subset"
CKPT_PATH="$HOME/ckpts/llm_mini_swe_tito"
...
python -m examples.train.mini_swe_agent.main_mini_swe \
  ...
  trainer.run_name="mini_swe_8B_tito" \
