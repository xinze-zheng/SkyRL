...
To get started, you can follow the instructions for installing via Docker in the [Installation Guide](../getting-started/installation) page, but using the `novaskyai/skyrl-train-ray-2.51.1-py3.12-cu12.8-megatron` image instead of the default image.
